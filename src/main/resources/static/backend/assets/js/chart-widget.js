(function ($) {
    ...
    var optionslinechart = {
        ...
        colors: [RicaAdminConfig.primary],
    ...
    var optionslinechart2 = {
        ...
        colors: [RicaAdminConfig.secondary],
        series: [
            {
                name: 'series1',
    ...
    var optionscolumnchart = {
        ...
        fill: {
            colors: [RicaAdminConfig.primary, RicaAdminConfig.secondary, '#51bb25'],
            type: 'gradient',
            gradient: {
                shade: 'light',
                type: 'vertical',
    ...
    var optionsproductchart = {
        ...
        fill: {
            colors: [RicaAdminConfig.primary, RicaAdminConfig.secondary],
            type: 'gradient',
            gradient: {
                shade: 'light',
                type: 'vertical',
    ...
    var optionsuserchart = {
        ...
        colors: [RicaAdminConfig.primary, RicaAdminConfig.secondary, '#51bb25', '#544fff'],
        title: {
    ...
    var optionscandlestickchart = {
        ...
        plotOptions: {
            candlestick: {
                colors: {
                    upward: RicaAdminConfig.primary,
                    downward: RicaAdminConfig.secondary
                }
            }
        },
        fill: {
    ...
    var optionsProgress1 = {
        ...
        fill: {
            ...
            type: 'gradient',
            gradient: {
                gradientToColors: [RicaAdminConfig.primary]
            }
        },
        series: [{
            name: 'Process 1',
