...
var options1 = {
  ...
  fill: {
    ...
    colors: [RicaAdminConfig.primary, RicaAdminConfig.primary, RicaAdminConfig.primary],
  },
  colors: [RicaAdminConfig.primary, RicaAdminConfig.secondary, RicaAdminConfig.secondary],
};
...
var options2 = {
  ...
  colors: [RicaAdminConfig.primary, RicaAdminConfig.primary, RicaAdminConfig.primary, RicaAdminConfig.primary],
  plotOptions: {
    bar: {
      vertical: true,
      columnWidth: '40%',
  ...
  fill: {
    ...
    colors: [function ({ value, seriesIndex, w }) {
      if (value < 0.75) {
        ...
        return RicaAdminConfig.primary
      }
    }]
  }
};
