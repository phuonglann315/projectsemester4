...
var options = {
    series: [{
        ...
        data: [10, 25, 10, 45, 15, 31, 12, 38, 15, 55, 25, 42, 0]

    }, {
        name: 'series2',
        // data: [2, 22, 35, 32, 40, 25, 50, 38, 42, 28, 20, 45, 0]
        data: [0, 20, 5, 40, 20, 34, 15, 45, 20, 55, 15, 35, 0]
    }],
    chart: {
        height: 240,
        type: 'area',
    ...
    markers: {
        strokeWidth: 3,
        colors: "#ffffff",
        strokeColors: [RicaAdminConfig.primary, RicaAdminConfig.secondary],
        hover: {
            size: 6,
        }
    },
...
var options1 = {
    ...
    markers: {
        size: 6,
        colors: ['#fff'],
        strokeColor: RicaAdminConfig.primary,
        strokeWidth: 3,
    },
    tooltip: {
        y: {
