									...
									<div class="card">
										...
										<div class="card-body form-group">
											<c:if test="${roomtypes==null }">
												<form
													action="${pageContext.request.contextPath }/hotel/contractinfo/createcontract"
													class="theme-form mega-form" method="GET">
													<div class="row g-3">
														<div class="col-sm-12">
															<h5 class="mb-0">Add Contract Info</h5>
														</div>
														<div class="col-sm-6 ">
															<select name="contractyear" class="select form-control"
																required="required">
														...
														<div class="col-sm-6 ">
															<input type="text"
																placeholder="Please, enter tax code..." name="taxcode"
																id="taxcode" class="form-control" required="required" />
															<div id="errorTax"></div>
														</div>
													...
													<div class="card-footer text-end"
														...
														<button type="submit" class="btn btn-primary me-3"
															id="submitAgency">Check</button>
													</div>
												</form>
											</c:if>
											<c:if test="${roomtypes!=null }">
											<div class="card-header">
												<h5>Add Contract Info</h5>
											</div>
													...
													<div class="row g-3" style="margin-bottom: 16px">
														...
														<div class="col-sm-6 ">
															<label class="form-label-title">Taxcode: </label> <input
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																value="${taxcode }" readonly="readonly" /> <input
																type="hidden" name="taxcode" value="${taxcode }">
														</div>
														<div class="col-sm-6 ">
															...
															<c:if test="${fromdate==null }">
																<input type="text"
																	style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																	value="01-01-${contractyear }" readonly="readonly" />
																<input type="hidden" name="fromdate"
																	value="01-01-${contractyear }">
															</c:if>
															<c:if test="${fromdate!=null }">
															<input type="text"
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																value="${fromdate}" readonly="readonly" /> <input
																type="hidden" name="fromdate" value="${fromdate }">
																</c:if>
														</div>

														<div class="col-sm-6 ">
															<label class="form-label-title">To Date:</label> <input
																type="text"
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																value="31-12-${contractyear }" readonly="readonly" /> <input
																type="hidden" name="todate"
																value="31-12-${contractyear }">
														...
														<div class="col-sm-12 ">
															...
															<select id="channel2" class="form-control" name="channel">
														...
														<div class="col-sm-4 ">
															<label class="form-label-title">Type:</label> <input
																type="text"
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																value="${r.roomstypename }" readonly="readonly" /> <input
																type="hidden" name="roomstypeid"
																value="${r.roomstypeid }">
														</div>
														<div class="col-sm-4 ">
															<label class="form-label-title">High Season Price:</label> <input
																type="text"
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																id="hightseasonprice" name="hightseasonprice" required="required" />
														</div>
														<div class="col-sm-4 ">
															<label class="form-label-title">Low Season Price:</label> <input
																type="text"
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																id="lowseasonprice" name="lowseasonprice" required="required" />
														</div>
														</c:forEach>	
														<div class="card-footer text-end">
															<input type="submit" class="btn btn-primary me-3"
																value="Submit" /> <a
																href="${pageContext.request.contextPath }/hotel/contractinfo/createcontract"
