							...
							<div class="card">
								...
								<input type="hidden" name="roomtypeid" value="${ roomtype.roomstypeid}">
									...
									<c:set var="c" value="${c+1 }"></c:set>
										...
										<c:set var="i" value="${i+1 }"></c:set>
										<c:if test="${c==1 }">
										<input class="form-control checkin" type="number" placeholder="Max" name="maxbeforcheckindate" min=1 id="${i }" >											   
										</c:if>
										<c:if test="${c<total && c>1 }">
										<input class="form-control checkin" type="number" placeholder="Max" name="maxbeforcheckindate" min=1 id="${i }" style="display: none">											   
										</c:if>
