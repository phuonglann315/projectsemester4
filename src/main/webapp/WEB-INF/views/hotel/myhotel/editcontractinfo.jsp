										...
										<div class="card-body form-group">
											...
											<div class="card-header">
												...
												<c:if test="${contractinfo.contractinfostt==1  }">
													<span style="color: #28a745; font-size: 19px;">Take
														effect</span>
												</c:if>
											</div>
											<form action="${pageContext.request.contextPath }/hotel/contractinfo/editcontract" class="theme-form mega-form" method="POST">	
											<div class="card-body form-group">
												<div class="row g-3" style="margin-bottom: 16px">
													...
													<div class="col-sm-6 ">
														<label class="form-label-title">Name:</label> <input
															...
															value=${contractinfo.contractname } required="required" />
													</div>
													<div class="col-sm-6 ">
														<label class="form-label-title">Taxcode: </label> <input
															style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
															value="${contractinfo.taxcode }" name="taxcode" required="required" />
													</div>
													<div class="col-sm-6 ">
													...
													<div class="col-sm-6 ">
														<label class="form-label-title">Phone:</label> <input
															type="text"
															style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
															id="phone" name="phone" readonly="readonly"
													...
													<div class="col-sm-12 ">
														<label class="form-label-title">Channel:</label> <select
															id="channel2" class="form-control" name="channel">
															<option
																${'AGENTCHANNEL'==contractinfo.channel?"selected":""}
																value="AGENTCHANNEL">Agent Channel</option>
															<option
																${'ONLINECHANNEL'==contractinfo.channel?"selected":""}
																value="ONLINECHANNEL">Online Channel</option>
													...
													<c:forEach var="r" items="${Contractinforoomtypes }">
														<div class="col-sm-4 ">
															<label class="form-label-title">Type:</label> <input
																type="text"
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																value="${r.roomtype.roomstypename }"   required="required" />
																<input type="hidden" name="roomstypeid" value="${r.roomtype.roomstypeid }">
															
														</div>
														<div class="col-sm-4 ">
															<label class="form-label-title">High Season Price:</label>
																 <input type="text"
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																id="hightseasonprice" name="hightseasonprice"
																 required="required" value="${r.hightseasonprice }" />
														</div>
														<div class="col-sm-4 ">
															<label class="form-label-title">Low Season Price:</label>
															<input type="text"
																style="border-radius: 0; text-transform: capitalize; border: 1px solid #ced4da; height: 48px; color: #495057; width: 100%; padding: 0px 12px; border-radius: 0.25rem; font-size: 17px;"
																id="lowseasonprice" name="lowseasonprice"
																 required="required" value="${r.lowseasonprice }" />
														</div>
													</c:forEach>
