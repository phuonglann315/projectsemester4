				...
				<div class="container-fluid" style="padding-top: 50px;">
					<div class="row">
						...
						<div class="col-xxl-12">
													...
													<c:forEach var="rs" items="${com }">
														<tr>
															...
															<td><span class="d-block "> <fmt:formatDate
																...
																<td  class="rating">
																<c:choose>      <c:when test="${ '0' <= rs.rating <= '5'}">
															...
															<td>
																...
																<div data-bs-toggle="tooltip" data-bs-placement="left"
																	title="Show">
																	<a href="${pageContext.request.contextPath }/hotel/reviews?reservationid=${rs.reservationid}">
							...
							<c:if test="${rs !=null }">
								<form
									action="${pageContext.request.contextPath }/hotel/replytocus"
									class="theme-form mega-form" method="POST">	 
									<input type="hidden" name="reservationid " value="${rs.reservationid}">
								<div class="card-body">
								<div class="mb-3">
											<label class="form-label-title">Customer: ${rs.customername } </label>
											
										</div>
								<div class="mb-3">
											<label class="form-label-title">Feedback form customer: 
											<c:choose>      <c:when test="${ '0' <= rs.rating <= '5'}">
																					        <i class="fa fa-star checked"></i>
										                                            		<i class="fa fa-star"></i>
										                                            		<i class="fa fa-star"></i>                                            
											...
											<p>${rs.customercomment }</p>
										</div>
									<div class="mb-3">
											<label class="form-label-title">Reply to customer</label>
											<textarea class="form-control" cols="100" rows="5" name="replyfromhotel" required="required"></textarea>
										</div>
								</div>
		...
		<div class="modal-dialog  modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-body">
					...
					<p>when you delete the hotel season, the created policies will be deleted accordingly</p>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
					<div class="button-box">
						<button type="button" class="btn btn--no " data-bs-dismiss="modal">No</button>
