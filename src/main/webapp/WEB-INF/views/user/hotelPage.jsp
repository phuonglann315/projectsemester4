...
<mt:userTemplate>
	...
	<!-- magnific css -->
	<link rel="stylesheet"
			href="${pageContext.request.contextPath }/resources/frontend/assets/css/magnific-popup.css">
	
	
	 <section class="hotel-single-section pt-0">	
	 		<c:forEach var="img" items="${hotel.hotel.hotelimages }">
	 		<img
					src="${pageContext.request.contextPath }/uploads/hotel/${ img.hotelimagename}"
                    ...
                    <div class="col-12">
                        <div class="hotel-name">
                            <div class="left-part">
                                <div class="top">
                                    ...
                                    <div class="share-buttons">
                                        <a href="#"
												class="btn btn-solid"><i class="far fa-share-square"></i> share</a>
                                        <a href="#"
												class="btn btn-solid"><i class="far fa-heart"></i> save</a>
                                    </div>
                                </div>
                                <p>${ hotel.hotel.street }, ${ hotel.hotel.ward.wardname }, ${ hotel.hotel.ward.city.cityname }, ${ hotel.hotel.ward.city.province.provincename }</p>
                            ...
                            <!-- <div class="right-part">
                                <h2 class="price">$${hotel.showprice } <span>/ per night</span>
									</h2>
                                <button class="btn btn-rounded btn-sm color1" id="book">book this now</button>
                            </div> -->
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-9 col-lg-8">
                       ...
                       <div class="image_section ">
                        <div class="row">
                            <div class="col-sm-12">                            
                                <div class="list-img arrow-dark zoom-gallery ratio3_2">                                 
                                   
                                    	<div class="slider-image">
                                    	 <c:forEach var="img" items="${hotel.hotel.hotelimages }">
                                    	<div><img src="${pageContext.request.contextPath }/uploads/hotel/${ img.hotelimagename}"
                                                class="img-fluid blur-up lazyload bg-img" alt=""></div>
                                    	</c:forEach>   
                                    	</div>
                    ...
                    <div class="description-section">
                        ...
                        <div class="description-details">
                            <div class="desc-box">
                                <div
										class="about page-section menu-part" id="about">
                         ...
                         <div class="menu-part page-section" id="rooms">
                         	<!-- <div class="list-view row content grid" > -->
                         		<c:forEach var="roomtype" items="${ listroomtype }">				 
                                    ...
                                    <tr>
                                           <td>
                                                <h6 class="room-title">${ roomtype.roomtype.roomstypename }</h6>                                           
								                    <div class="slide-1 zoom-gallery no-arrow" style="max-width: 230px; max-height: 210px">
								                         <c:forEach var="img" items="${ roomtype.roomtype.roomtypeimages}">
								                            <div>
								                                  <a href="${pageContext.request.contextPath }/uploads/room/${img.roomtypeimagename}">
								                                       <img src="${pageContext.request.contextPath }/uploads/room/${img.roomtypeimagename}"
								                                                class="img-fluid blur-up lazyload " width="200px" height="200px" alt="">								                                         
								                                    </a>
								                                 </div>  
								                           </c:forEach>                                                                 
								                      </div>                                                                                                                                                     
                                                    ...
                                                    <div class="row">
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <ul>
                                                                    <li><img
																			src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/tour/bed.png"
                                                                    ...
                                                                    <li><img
																			src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/hotel/television.png"
																			class="img-fluid blur-up lazyload" alt="">
                                                                        LCD TV</li>
                                                                    <li><img
																			src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/hotel/couch.png"
																			class="img-fluid blur-up lazyload" alt="">
                                                                        couch
                                                                    </li>
                                                                </ul>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <ul>
                                                                    <li><i
																			class="fas fa-check"></i> Wi-Fi</li>
                                                                    <li><i
																			class="fas fa-check"></i> Breakfast</li>
                                                                    <li><i
																			class="fas fa-check"></i> ${roomtype.roomtype.numcusdefault } guests</li>
																	<li><i
																			class="fas fa-check"></i>Avaiable room: ${roomtype.availableroom }</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    <div>
                                                           <h6>
																<del>$${roomtype.roomtype.publicprice }</del>
															</h6>
                                                        <h5>$${roomtype.showprice }</h5>
                                                        <span>per night</span>                                                   
                                                        	<input type="hidden" value="">
                                                        	<c:choose>
                                                        		<c:when test="${roomtype.availableroom == 0 }">
                                                        			<button class="btn btn-rounded btn-sm color1 book2" disabled="disabled" >
                                                        						sold out</button>
                                                        		</c:when>
                                                        		<c:when test="${roomtype.availableroom > 0 }">
                                                        			<button class="btn btn-rounded btn-sm color1 book2" value="${roomtype.roomtype.roomstypeid }">
                                                        						book now</button>
                                                        		</c:when>
                                                        	</c:choose>
                            ...
                            <div class="desc-box">
                                <h4 class="content-title">facility</h4>
                                <div
										class="menu-part page-section facility" id="facility">
                                    <div class="row">
                                        <div class="col-xl-3 col-6">
                                            <h6>
													<img
														src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/hotel/verified.png"
														class="img-fluid blur-up lazyload" alt=""> basic facility</h6>
                                            <ul>
                                                <li><i
														class="fas fa-check"></i> Free Wi-Fi</li>
                                                <li><i
														class="fas fa-check"></i> Room Service</li>
                                                <li><i
														class="fas fa-check"></i> Elevator Lift</li>
                                                <li><i
														class="fas fa-check"></i> Laundry Service</li>
                                                <li><i
														class="fas fa-check"></i> Power Backup</li>
                                                <li><i
														class="fas fa-check"></i> Free Parking</li>
                                            </ul>
                                        </div>
                                        <div class="col-xl-3 col-6">
                                            <h6>
													<img
														src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/hotel/credit-card.png"
														class="img-fluid blur-up lazyload" alt=""> payment mode</h6>
                                            <ul>
                                                <li><i
														class="fas fa-check"></i> visa card</li>
                                                <li><i
														class="fas fa-check"></i> master card</li>
                                                <li><i
														class="fas fa-check"></i> American express</li>
                                                <li><i
														class="fas fa-check"></i> debit card</li>
                                                <li><i
														class="fas fa-check"></i> cash</li>
                                                <li><i
														class="fas fa-check"></i> online banking</li>
                                            </ul>
                                        </div>
                                        <div class="col-xl-3 col-6">
                                            <h6>
													<img
														src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/hotel/cctv.png"
														class="img-fluid blur-up lazyload" alt=""> security</h6>
                                            <ul>
                                                <li><i
														class="fas fa-check"></i> Security Guard</li>
                                                <li><i
														class="fas fa-check"></i> CCTV</li>
                                                <li><i
														class="fas fa-check"></i> emergency exit</li>
                                                <li><i
														class="fas fa-check"></i> doctor on call</li>
                                            </ul>
                                        </div>
                                        <div class="col-xl-3 col-6">
                                            <h6>
													<img
														src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/hotel/tray.png"
														class="img-fluid blur-up lazyload" alt=""> food & drinks</h6>
                                            <ul>
                                                <li><i
														class="fas fa-check"></i> restaurant</li>
                                                <li><i
														class="fas fa-check"></i> bar</li>
                                            </ul>
                                            <h6 class="mt-2">
													<img
														src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/hotel/barbell.png"
														class="img-fluid blur-up lazyload" alt=""> activities</h6>
                                            <ul>
                                                <li><i
														class="fas fa-check"></i> gym</li>
                                                <li><i
														class="fas fa-check"></i> game zone</li>
                                                <li><i
														class="fas fa-check"></i> swimming pool</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
						             ...
						             <div class="blog-single-detail">      
						                  <div class="comment-section">						                            
						                       <div class="comment-wrapper">
						                            <c:forEach var="list" items="${listroomtype }">						                           
						                            <c:forEach var="review" items="${list.roomtype.reservations }"> 
						                         	<c:if test="${not empty review.customercomment }"> 
						                         	    <div class="comment-box">
						                                    <div class="media">
						                                        <img src="${pageContext.request.contextPath }/uploads/account/${review.account.avatar }" class="img-fluid blur-up lazyload"
						                                            alt="">
						                                    ...
						                                    <c:if test="${not empty review.replyfromhotel }">
						                                    	 <div class="media inner-comment">
						                                        <img src="${pageContext.request.contextPath }/resources/backend/images/hotel/${hotel.hotel.logo}" class="img-fluid blur-up lazyload"
						                                            alt="">
						                                        <div class="media-body">
						                                            <div class="title">
						                                                <div class="comment-user">
                            ...
                            <div class="desc-box">
                                ...
                                <div
										class="menu-part policy page-section" id="policy">
                    ...
                    <div
							class="special-section related-box ratio3_2 grid-box">
                        <div class="slider-3 no-arrow">
                        
                         <c:forEach var="list" items="${listrelative }">
                    <div>
                                <div class="special-box p-0">
                                    ...
                                    <div class="special-content">                                       
                                            <h5><span><i
														class="fas fa-map-marker-alt"></i> ${list.hotel.ward.wardname }, ${list.hotel.ward.city.cityname } </span></h5>
                                            <br>
                ...
                <div class="col-xl-3 col-lg-4" id="booking">
                    <div class="sticky-cls">
                        <div class="single-sidebar">
                            <div class="selection-section">
                                <div class="overlay-map">
                                    <img
											src="${pageContext.request.contextPath }/resources/frontend/assets/images/map-image.svg"
											class="img-fluid blur-up lazyload" alt="">
                                    <iframe
                                ...
                                <div class="price-part">
                                    <div class="left-part">
                                        ...
                                        <span class="mt-2"><i
												class="fas fa-check"></i> Room only</span>
                                        <span><i
												class="fas fa-check"></i> non refundable</span>
                                    </div>
                                    <div class="right-part">
                                        <span>per night</span>                                      
                                        <h6>$${ hotel.showprice }</h6>
                                    </div>
                                </div>
                                <div class="book-btn-section">
                                <%-- <form method="POST" action="${pageContext.request.contextPath }/user/booking"> --%>
                                <div class="rooms-section">
                                	<c:choose>
                                    	<c:when test="${not empty today }">
                                    	<input type="text" class="form-control" required="required"
											id="timeCheckIn" value="${today }" placeholder="Check In" name="checkin"/>
                                    	</c:when>
                                    	<c:when test="${not empty checkin }">
                                    	<input type="text" class="form-control" required="required"
											id="timeCheckIn" value="${checkin }" placeholder="Check In" name="checkin"/>
                                    	</c:when>
                                    </c:choose>                               	 
                                	</div>
                                   ...
                                   <div class="rooms-section">
                                    ...
                                    <c:choose>
                                    	...
                                    	<input type="text" class="form-control" required="required"
											id="timeCheckOut" value="${tomorrow }" placeholder="Check Out" name="checkout" />
                                    	</c:when>
                                    	<c:when test="${not empty checkout }">
                                    	<input type="text" class="form-control" required="required"
											id="timeCheckOut" value="${checkout }" placeholder="Check Out" name="checkout" />
                                    	</c:when>
                                    </c:choose>
                                   </div> 
                                    <div class="rooms-section">                                
                                     	<c:choose>
                                            	<c:when test="${not empty room }">
                                            		<input type="number" min="1" max="9" id="room" required="required" name="totalrooms"
													 class="form-control" value="${room }" placeholder="Room">
                                            	</c:when>
                                            	<c:when test="${empty room }">
                                            		<input type="number" min="1" max="9" id="room" required="required" placeholder="Room"
													name="totalrooms" class="form-control" value="1">
                                            	</c:when>
                                         </c:choose>  
                                     </div>
                                    <div class="price-part" style="height: 20px">
                                     <div class="left-part">
                                    <label>Rooms</label> 
                                    </div>
                                    </div>  
                                    <div class="price-part" style="height: 20px">
                                     <div class="left-part">
                                    <label id="checkmaxroom" style="color: red;"></label> 
                                    </div>
                                    </div>
                                                                                                                                                                                                             
                                       <input type="hidden" value="${hotel.contractid }" id="contractid">
                                       <input type="hidden" value="${hotel.hotel.hotelid }" id="hotelid">
                                      <!-- <input type="submit" class="btn btn-rounded btn-sm color1" id="book3" value="book this now"> -->
                                <!-- </form> -->  
                                </div>
                            </div>
                        </div>
                        <div class="single-sidebar">
                            ...
                            <p class="address"> <i
										class="fas fa-map-marker-alt"></i>${ hotel.hotel.street }, ${ hotel.hotel.ward.wardname }, ${ hotel.hotel.ward.city.cityname }, ${ hotel.hotel.ward.city.province.provincename }
                            </p>
                            <p>
									<i class="fas fa-phone-alt"></i> 123 254 121</p>
                            <a href="#">
                                <p>
										<i class="fas fa-envelope"></i> Contact@seaview.com</p>
                            </a>
    ...
    <div class="book-panel">
        <button type="button" class="btn bottom-btn theme-color">book now</button>
        <button data-bs-toggle="modal" data-bs-target="#enquiryModal"
				type="button" class="btn bottom-btn">enquiry</button>
    </div>
    <!-- book now section end -->


    <!-- enquiry modal start-->
    <div class="modal fade enquiry-modal" id="enquiryModal"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div>
                        ...
                        <p>if you have any queries kindly take a moment to fill this form, our representative will
