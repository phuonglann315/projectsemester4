        ...
        <div class="container">
            <div class="row success-detail mt-0">
                <div class="col">
                    ...
                    <p>thank you for you payment. we have received your payment successfully. your reservaiotn ID is
                        "#${reservation.reservationidcode }", you will get an email confirmation soon!</p>
