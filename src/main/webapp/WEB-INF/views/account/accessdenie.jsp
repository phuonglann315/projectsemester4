	   ...
	   <section class=" section-b-space bg-inner success-section">
        <div class="container">
            <div class="row success-detail mt-0">
                <div class="col">
                    <img src="${pageContext.request.contextPath }/resources/frontend/assets/images/icon/failure-icon.png" class="img-fluid blur-up lazyload" alt="">
                    ...
                    <button type="submit" class="btn btn-solid color1">go to home page</button>
                </div>
            </div>
        </div>
    </section>
