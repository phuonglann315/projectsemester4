...
<body>
	...
	<script
		src="${pageContext.request.contextPath }/resources/backend/assets/js/datepicker/date-picker/datepicker.js"></script>

	<script
		src="${pageContext.request.contextPath }/resources/backend/assets/js/datepicker/date-picker/datepicker.en.js"></script>

	<script
		src="${pageContext.request.contextPath }/resources/backend/assets/js/datepicker/date-picker/datepicker.custom.js"></script>
