...
<div class="modal fade " id="ChangeStatus" data-bs-backdrop="static"
		...
		<div class="modal-dialog  modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="button-box">
					<c:if test="${stt==0 }">
					<a href="${pageContext.request.contextPath }/hotel/policies/editpolicies?year=${nextyear}&roomtype=${typeroomSelected}&applyfor=${applyfor}&stt=2"
							class="btn btn--no " >Non-Active</a>
					
					<a href="${pageContext.request.contextPath }/hotel/policies/editpolicies?year=${nextyear}&roomtype=${typeroomSelected}&applyfor=${applyfor}&stt=1"
	...
	<script
		...
		<script
		src="${pageContext.request.contextPath }/resources/backend/assets/myajax/createAddonServiceajax.js"></script>
