...
<body>
	...
	<script src="${pageContext.request.contextPath }/resources/backend/assets/js/dropzone/dropzone.js"></script>
	<script src="${pageContext.request.contextPath }/resources/backend/assets/js/dropzone/dropzone-script.js"></script>

	<!--ckEditor js start-->
	<script src="${pageContext.request.contextPath }/resources/backend/assets/js/ckeditor/ckeditor.js"></script>
	<script src="${pageContext.request.contextPath }/resources/backend/assets/js/ckeditor/styles.js"></script>
	<script src="${pageContext.request.contextPath }/resources/backend/assets/js/ckeditor/ckeditor.custom.js"></script>
<script
		src="${pageContext.request.contextPath }/resources/backend/assets/myajax/creatroomtypeajax.js"></script>
	<!--ckEditor js end-->
	<!-- /Toan Code -->
</body>
